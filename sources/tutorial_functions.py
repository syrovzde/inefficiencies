...
def exctract_results(res_engine):
    ...
    all_results['matchid'] = []
    all_results['res'] = []
    match_ids = pd.read_csv('csv_files'+os.sep + 'match_ids_sample.csv')
    i=0
    ...
    df.to_csv('csv_files' + os.sep + 'results_sample.csv')
...
def arbitrage_profit_tutorial(p=1,
    ...
    home_lambdas = pd.read_csv('csv_files'+os.sep +'home.csv')
    away_lambdas = pd.read_csv('csv_files' + os.sep + 'away.csv')
    results = pd.read_csv('csv_files' + os.sep + 'results_sample.csv')
    matchids_profit = []
...
if __name__ == '__main__':
    #file = 'csv_files'+os.sep + '1x2_sample.csv'
